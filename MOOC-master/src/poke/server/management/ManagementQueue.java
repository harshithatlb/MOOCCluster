...
public class ManagementQueue {
	...
	public static void startup(ServerConf conf) {
		System.out.println("iworker Management Queue-----------------"+ iworker);
		if (iworker != null)
			return;
		System.out.println("startup Management Queue-----------------");
		iworker = new InboundMgmtWorker(tgroup, 1,conf);
		iworker.start();
